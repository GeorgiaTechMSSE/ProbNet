...
### output the graph data into a text file that are visualized at
###  http://ashitani.jp/gv/
#   copy the output result in 'dotgraph.txt' and past in the dialog on left
#   of the webpage http://ashitani.jp/gv/
    ...
    dijkstra(g, g.get_vertex('S1')) 

    target = g.get_vertex('S11')
    path = [target.get_id()]
